...
public class XtbGenerator {
    ...
    protected File translationFile;

    protected File xtbOutputFile;

    public static void process(String lang, String projectId, Collection<SourceFile> jsFiles, File translationFile, File xtbOutputFile)
            throws IOException {
    ...
    public void setTranslationFile(File translationFile) {
        this.translationFile = translationFile;
    }

    public void setXtbOutputFile(File xtbOutputFile) {
    ...
    protected Writer getOutputWriter() throws IOException {
        ...
        if (!xtbOutputFile.exists()) {
        	xtbOutputFile.createNewFile();
        }
        
        return new OutputStreamWriter(new FileOutputStream(xtbOutputFile), "UTF-8");
    }
}
